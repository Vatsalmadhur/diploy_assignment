...
const Landing = () => {
  return (
    <>
    <div className="w-screen h-screen bg-[url('/assets/homeBg.svg')] bg-center bg-cover bg-no-repeat flex   items-center justify-around" >
        ...
        <div className='my-5' >
          {  ["100% free to use","900+ High-Quality Products","Largest Global Print Network"].map((ele)=>(
            ...
            <span className='bg-white w-8 h-8 rounded-full flex items-center justify-center'>
                <img src="/assets/tickIcon.png" alt="icon" className='w-5 h-5' />
            </span>
